...
export default function HomePage() {
  return (
    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 lg:py-24 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            >
              A decision-support tool for screening chest X-rays using deep
              learning. Upload an image, select a model, and review the
          ...
          <div className="relative">
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(135deg, #1a2744 0%, #0d1525 50%, #1a2744 100%)`,
                }}
              />
              <div className="absolute inset-0 flex items-center justify-center p-8">
                <div
                  className="w-full max-w-sm aspect-square rounded-lg border border-white/10 flex items-center justify-center overflow-hidden relative"
              ...
              <div
                className="absolute bottom-0 left-0 right-0 backdrop-blur-sm border-t border-white/10 p-4"
                style={{ backgroundColor: 'rgba(10,15,26,0.90)' }}
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[#2DD4A0] text-xs font-bold">
                      AI Confidence: 87%
                    </p>
                    <p className="text-gray-500 text-[10px]">
                      Probability Pattern Found
                    </p>
                  </div>
      ...
      <section
        id="how-it-works"
        className="max-w-7xl mx-auto px-6 py-16 w-full"
      >
        <div className="text-center mb-12">
          ...
          <p
            ...
            style={{ color: 'var(--text-secondary)' }}
          >
            Three simple steps from image upload to actionable clinical
            insights.
          </p>
        </div>
      ...
      <section id="about" className="max-w-7xl mx-auto px-6 py-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="grid grid-cols-2 gap-4">
            {['/image.png', '/image copy.png', '/image copy 2.png'].map(
              (src, i) => (
                <div
                  key={i}
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--text-muted)' }}
              >
                This tool is a diagnostic support aid only and does not replace
                the judgement of a qualified radiologist or physician.
              </p>
            </div>
          </div>
          ...
          <div>
            <h2
              className="text-2xl sm:text-3xl font-extrabold mb-6 leading-tight"
              style={{ color: 'var(--text-primary)' }}
            >
              Explainable AI for
              <br />
